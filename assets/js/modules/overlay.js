...
function openOverlay(clickedElement) {
    ...
    if (targetId === '#apercu' && DOM.backgroundVideo) {
...
export function initOverlay() {
    ...
    if (DOM.mainCloseButton) DOM.mainCloseButton.addEventListener('click', closeOverlay);

    if (DOM.pageContainer) DOM.pageContainer.addEventListener('click', (event) => {
